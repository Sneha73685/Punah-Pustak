...
| `repository.py` | `RefreshTokenRepository` — `create`, `get_by_hash`, `revoke`, `revoke_family` (reuse detection), `revoke_all_for_user` (suspension). |
